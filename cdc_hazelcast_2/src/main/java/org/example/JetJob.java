...
public class JetJob implements Serializable{
    ...
    public static void main(String[] args) {
        ...
        sss.withoutTimestamps()
                ...
                (Sinks.mapWithMerging("customerDependentCacheWithCustomerIdAsKey",
                        ...
                        // they are both hashmaps
                        (oldValue, newValue) -> 
                        {
                        	Integer i = (Integer)(newValue.keySet().toArray()[0]) ;	                        	
                        	
                        	// this operation either adds or replaces existing dependent object in the cache
      ...
      ClientConfig clientCfg = new ClientConfig();
        ...
        //clientCfg.getNetworkConfig().addAddress("192.168.1.50:5820");     
 ...
 // only consider customers table
        ...
        //sink to remote customerDependent cache with customerId, merging with existing object Array and adding the new object to the same array
        ...
        // No DataSerializerFactory registered for namespace: -10001
        ...
        */
        ...
        JobConfig cfg = new JobConfig().setName("mysql-monitor2");
        //cfg.addClass(Customer.class);
        //cfg.addClass(CustomerDependent.class);
